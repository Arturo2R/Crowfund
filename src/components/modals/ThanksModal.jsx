      ...
      <Transition show={open} as={React.Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-[24rem] p-12 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                <Dialog.Title
                  as="h3"
